  ...
  function finish() {
    if ((endTop >= 98) && (endTop <= 292) && (endLeft >= 114) && (endLeft <= 710)) {
      if ((direction == "right") && (endLeft < 362)) {
        incrementScore();
        if (chanceCount < 1) { modalElem5.setAttribute("class", "modalX active"); }
        else {
          if (score > 1) { modalElem7.setAttribute("class", "modalX active"); }
          else {
            modalElem6.innerHTML = "You scored " + score + " goal(s) out of 2. Click to try again";
            modalElem6.setAttribute("class", "modalX active");
          }
        }
      }
      ...
      if (chanceCount < 1) { modalElem4.setAttribute("class", "modalX active"); }
      else {
        modalElem6.innerHTML = "You scored " + score + " goal(s) out of 2.. Click to try again";
        modalElem6.setAttribute("class", "modalX active");
      }
...
function kickingProcess() {
  if ((verticalBallStopped == false) && (horizontalBallStopped == false) && (powerBallStopped == false)) {
    ...
    modalElem4.setAttribute("class", "modalX");
    modalElem5.setAttribute("class", "modalX");
    modalElem6.setAttribute('class', 'modalX');
    modalElem7.setAttribute('class', 'modalX');
    refreshScene();
  }
}
...
document.getElementById('zee-game').onclick = function () {
  kickingProcess();
}
